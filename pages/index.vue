<template>
  <main class="bg-blue text-white flex-1 flex flex-col overflow-hidden">
    <!--    <nuxt-link-->
    <!--      to="/me"-->
    <!--      class="flex-1 border-b p-4 hover:bg-white hover:text-blue transition-colors duration-200 ease-in flex items-center cursor-pointer relative overflow-hidden"-->
    <!--    >-->
    <!--      <div class="flex-grow">-->
    <!--        <h2 class="text-2xl font-bold mb-2">{{ $t('home.aboutTitle') }}</h2>-->
    <!--        <p class="hidden md:block">-->
    <!--          {{ $t('home.aboutDesc') }}-->
    <!--        </p>-->
    <!--      </div>-->
    <!--      <fa :icon="['far', 'arrow-right']" class="ml-6 text-4xl md:text-6xl" />-->
    <!--      <fa-->
    <!--        :icon="['far', 'user-tie']"-->
    <!--        class="opacity-25 absolute -bottom-2 lg:-bottom-4 right-12 md:right-4 text-5xl md:text-8xl"-->
    <!--      />-->
    <!--    </nuxt-link>-->
    <!--    <nuxt-link-->
    <!--      to="/projects"-->
    ...
    <!--    >-->
    <!--      <div class="flex-grow">-->
    <!--        <h2 class="text-2xl font-bold mb-2">{{ $t('home.projectsTitle') }}</h2>-->
    <!--        <p class="hidden md:block">-->
    <!--          {{ $t('home.projectsDesc') }}-->
    <!--        </p>-->
    <!--      </div>-->
    ...
    <!--    <nuxt-link-->
    <!--      to="/contact"-->
    <!--      class="flex-1 p-4 hover:bg-white hover:text-blue transition-colors duration-200 ease-in flex items-center cursor-pointer relative overflow-hidden"-->
    <!--    >-->
    <!--      <div class="flex-grow">-->
    <!--        <h2 class="text-2xl font-bold mb-2">{{ $t('home.contactTitle') }}</h2>-->
    <!--        <p class="hidden md:block">-->
    <!--          {{ $t('home.contactDesc') }}-->
    <!--        </p>-->
    <!--      </div>-->
    ...
    <!--    </nuxt-link>-->
    <div
      class="flex-1 border-b p-4 flex items-center relative overflow-hidden group"
    >
      <div class="flex-grow">
      ...
      <fa
        ...
        class="opacity-25 md:absolute bottom-2 lg:bottom-4 right-2 md:right-4 text-6xl md:text-8xl"
      />
    </div>
    <a
      href="https://transittracker.ca"
      class="flex-1 p-4 hover:bg-white hover:text-tt-primary transition-colors duration-200 ease-in flex items-center cursor-pointer relative overflow-hidden group"
    >
      <div class="flex-grow">
        <h2 class="text-2xl font-bold mb-2">{{ $t('home.ttTitle') }}</h2>
        <p>
          {{ $t('home.ttDesc') }}
        </p>
      </div>
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        class="w-24 h-24 opacity-25 group-hover:opacity-100 absolute bottom-2 lg:bottom-4 right-12 md:right-4 text-5xl md:text-8xl z-10 hidden md:block"
      >
        <path
          fill="currentColor"
          d="M12 0C7.18 0 3.262 3.917 3.262 8.738c0 5.082 5.272 11.927 7.617 14.738.582.699 1.645.699 2.228 0 2.359-2.811 7.63-9.656 7.63-14.738C20.738 3.918 16.82 0 12 0zm0 4.238c2.094 0 3.79.237 3.79 1.895v4.737c0 .417-.185.79-.474 1.051v.607c0 .393-.322.71-.71.71a.713.713 0 01-.711-.71v-.237h-3.79v.237a.71.71 0 11-1.42 0v-.607a1.414 1.414 0 01-.474-1.051V6.133c0-1.658 1.695-1.895 3.79-1.895zM9.158 6.133V8.5h5.684V6.133zm.71 3.79a.71.71 0 100 1.42.71.71 0 100-1.42zm4.264 0a.71.71 0 100 1.42.71.71 0 100-1.42z"
        />
      </svg>
      <div
        class="hidden md:block absolute left-0 bottom-0 text-tt-secondary bg-pattern-tt bg-center bg-contain opacity-0 group-hover:opacity-100 transition-opacity duration-200 ease-in w-full h-32"
      ></div>
    </a>
  </main>
</template>
